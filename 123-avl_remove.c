...
/**
 * bal - Balances the AVL tree after insertion or deletion.
...
/**
 * successor - Finds the next successor,
...
/**
 * remove_type - Removes a node from a BST tree depending on its children.
 * @root: Pointer to the node to remove.
 * Return: 0 if the node has no children,
 *  or the value of the new node if it has.
 */
 ...
 * @value: Value of the node to remove.
 * Return: Pointer to the updated AVL tree.
 */
