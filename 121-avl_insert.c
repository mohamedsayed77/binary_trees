...
/**
 * r_insert_node - Inserts a node with a specific value into an AVL tree.
 * @tree: A pointer to a pointer to the root node of the AVL tree struct.
 * @parent: The parent node of the AVL tree.
 * @new: A pointer to a pointer indicating the left or right insertion.
 * @nval: The value to insert into the AVL tree.
 * Return: A pointer to the new root after insertion, or NULL if failed.
 */
